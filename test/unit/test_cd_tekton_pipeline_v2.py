...
class TestCreateTektonPipeline:
    ...
    def test_create_tekton_pipeline_all_params(self):
        ...
        mock_response = '{"name": "name", "status": "configured", "resource_group": {"id": "id"}, "toolchain": {"id": "id", "crn": "crn:v1:staging:public:toolchain:us-south:a/0ba224679d6c697f9baee5e14ade83ac:bf5fa00f-ddef-4298-b87b-aa8b6da0e1a6::"}, "id": "id", "definitions": [{"source": {"type": "type", "properties": {"url": "url", "branch": "branch", "tag": "tag", "path": "path", "tool": {"id": "id"}}}, "href": "href", "id": "id"}], "properties": [{"name": "name", "value": "value", "href": "href", "enum": ["enum"], "type": "secure", "locked": true, "path": "path"}], "updated_at": "2019-01-01T12:00:00.000Z", "created_at": "2019-01-01T12:00:00.000Z", "triggers": [{"type": "type", "name": "start-deploy", "href": "href", "event_listener": "event_listener", "id": "id", "properties": [{"name": "name", "value": "value", "href": "href", "enum": ["enum"], "type": "secure", "path": "path", "locked": true}], "tags": ["tags"], "worker": {"name": "name", "type": "type", "id": "id"}, "max_concurrent_runs": 4, "enabled": true, "favorite": false, "limit_waiting_runs": false}], "worker": {"name": "name", "type": "type", "id": "id"}, "runs_url": "runs_url", "href": "href", "build_number": 1, "next_build_number": 1, "enable_notifications": true, "enable_partial_cloning": true, "enabled": true}'
        responses.add(
            responses.POST,
            url,
            body=mock_response,
...
class TestListTektonPipelineRuns:
    ...
    def test_list_tekton_pipeline_runs_all_params(self):
        ...
        mock_response = '{"pipeline_runs": [{"id": "id", "href": "href", "user_info": {"iam_id": "iam_id", "sub": "sub"}, "status": "pending", "definition_id": "definition_id", "definition": {"id": "id"}, "description": "description", "worker": {"name": "name", "agent_id": "agent_id", "service_id": "service_id", "id": "id"}, "pipeline_id": "pipeline_id", "pipeline": {"id": "id"}, "listener_name": "listener_name", "trigger": {"type": "type", "name": "start-deploy", "href": "href", "event_listener": "event_listener", "id": "id", "properties": [{"name": "name", "value": "value", "href": "href", "enum": ["enum"], "type": "secure", "path": "path", "locked": true}], "tags": ["tags"], "worker": {"name": "name", "type": "type", "id": "id"}, "max_concurrent_runs": 4, "enabled": true, "favorite": false, "limit_waiting_runs": false}, "event_params_blob": "event_params_blob", "trigger_headers": "trigger_headers", "properties": [{"name": "name", "value": "value", "href": "href", "enum": ["enum"], "type": "secure", "locked": true, "path": "path"}], "created_at": "2019-01-01T12:00:00.000Z", "updated_at": "2019-01-01T12:00:00.000Z", "run_url": "run_url", "error_message": "error_message"}], "limit": 20, "first": {"href": "href"}, "next": {"href": "href"}, "last": {"href": "href"}}'
        responses.add(
            responses.GET,
            url,
            body=mock_response,
...
class TestCreateTektonPipelineRun:
    ...
    def test_create_tekton_pipeline_run_all_params(self):
        ...
        pipeline_run_trigger_model['secure_properties'] = {'secure-property-key': 'secure value'}
        pipeline_run_trigger_model['headers'] = {'source': 'api'}
        pipeline_run_trigger_model['body'] = {'message': 'hello world', 'enable': 'true', 'detail': {'name': 'example'}}
        ...
        # Validate body params
        req_body = json.loads(str(responses.calls[0].request.body, 'utf-8'))
        assert req_body['description'] == 'My custom manual PipelineRun'
...
class TestListTektonPipelineTriggers:
    ...
    def test_list_tekton_pipeline_triggers_all_params(self):
        ...
        mock_response = '{"triggers": [{"type": "type", "name": "start-deploy", "href": "href", "event_listener": "event_listener", "id": "id", "properties": [{"name": "name", "value": "value", "href": "href", "enum": ["enum"], "type": "secure", "path": "path", "locked": true}], "tags": ["tags"], "worker": {"name": "name", "type": "type", "id": "id"}, "max_concurrent_runs": 4, "enabled": true, "favorite": false, "limit_waiting_runs": false}]}'
        responses.add(
            responses.GET,
            url,
            body=mock_response,
...
class TestCreateTektonPipelineTrigger:
    ...
    def test_create_tekton_pipeline_trigger_all_params(self):
        ...
        # Set up mock
        url = preprocess_url('/tekton_pipelines/94619026-912b-4d92-8f51-6c74f0692d90/triggers')
        mock_response = '{"type": "type", "name": "start-deploy", "href": "href", "event_listener": "event_listener", "id": "id", "properties": [{"name": "name", "value": "value", "href": "href", "enum": ["enum"], "type": "secure", "path": "path", "locked": true}], "tags": ["tags"], "worker": {"name": "name", "type": "type", "id": "id"}, "max_concurrent_runs": 4, "enabled": true, "favorite": false, "limit_waiting_runs": false}'
        responses.add(
            responses.POST,
            url,
            body=mock_response,
        ...
        assert req_body['limit_waiting_runs'] == False
...
class TestUpdateTektonPipelineTrigger:
    ...
    def test_update_tekton_pipeline_trigger_all_params(self):
        ...
        trigger_patch_model['limit_waiting_runs'] = False
...
class TestListTektonPipelineTriggerProperties:
    ...
    def test_list_tekton_pipeline_trigger_properties_all_params(self):
        ...
        mock_response = '{"properties": [{"name": "name", "value": "value", "href": "href", "enum": ["enum"], "type": "secure", "path": "path", "locked": true}]}'
        responses.add(
            responses.GET,
            url,
            body=mock_response,
...
class TestCreateTektonPipelineTriggerProperties:
    ...
    def test_create_tekton_pipeline_trigger_properties_all_params(self):
        ...
        mock_response = '{"name": "name", "value": "value", "href": "href", "enum": ["enum"], "type": "secure", "path": "path", "locked": true}'
        responses.add(
            responses.POST,
            url,
            body=mock_response,
...
class TestModel_PipelineRun:
    ...
    def test_pipeline_run_serialization(self):
        ...
        trigger_property_model['locked'] = True
        ...
        trigger_model['limit_waiting_runs'] = False
        ...
        pipeline_run_model_json['description'] = 'testString'
...
class TestModel_PipelineRunsCollection:
    ...
    def test_pipeline_runs_collection_serialization(self):
        ...
        pipeline_run_model['description'] = 'testString'
...
class TestModel_Property:
    ...
    def test_property_serialization(self):
        ...
        property_model_json['locked'] = True
...
class TestModel_TriggerPatch:
    ...
    def test_trigger_patch_serialization(self):
        ...
        trigger_patch_model_json['limit_waiting_runs'] = False
...
class TestModel_TriggerProperty:
    ...
    def test_trigger_property_serialization(self):
        ...
        trigger_property_model_json['locked'] = True
...
class TestModel_TriggerGenericTrigger:
    ...
    def test_trigger_generic_trigger_serialization(self):
        ...
        trigger_generic_trigger_model_json['limit_waiting_runs'] = False
...
class TestModel_TriggerManualTrigger:
    ...
    def test_trigger_manual_trigger_serialization(self):
        ...
        trigger_manual_trigger_model_json['limit_waiting_runs'] = False
...
class TestModel_TriggerTimerTrigger:
    ...
    def test_trigger_timer_trigger_serialization(self):
        ...
        trigger_timer_trigger_model_json['limit_waiting_runs'] = False
