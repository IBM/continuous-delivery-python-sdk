...
class TestModel_ToolchainEventPrototypeData:
    ...
    def test_toolchain_event_prototype_data_serialization(self):
        ...
        toolchain_event_prototype_data_model_json['application_json'] = toolchain_event_prototype_data_application_json_model
        ...
        toolchain_event_prototype_data_model = ToolchainEventPrototypeData.from_dict(toolchain_event_prototype_data_model_json)
        assert toolchain_event_prototype_data_model != False

        # Construct a model instance of ToolchainEventPrototypeData by calling from_dict on the json representation
        toolchain_event_prototype_data_model_dict = ToolchainEventPrototypeData.from_dict(toolchain_event_prototype_data_model_json).__dict__
...
class TestModel_ToolchainEventPrototypeDataApplicationJson:
    ...
    def test_toolchain_event_prototype_data_application_json_serialization(self):
        ...
        toolchain_event_prototype_data_application_json_model = ToolchainEventPrototypeDataApplicationJson.from_dict(toolchain_event_prototype_data_application_json_model_json)
        assert toolchain_event_prototype_data_application_json_model != False

        # Construct a model instance of ToolchainEventPrototypeDataApplicationJson by calling from_dict on the json representation
        toolchain_event_prototype_data_application_json_model_dict = ToolchainEventPrototypeDataApplicationJson.from_dict(toolchain_event_prototype_data_application_json_model_json).__dict__
        toolchain_event_prototype_data_application_json_model2 = ToolchainEventPrototypeDataApplicationJson(**toolchain_event_prototype_data_application_json_model_dict)

        # Verify the model instances are equivalent
        assert toolchain_event_prototype_data_application_json_model == toolchain_event_prototype_data_application_json_model2

        # Convert model instance back to dict and verify no loss of data
        toolchain_event_prototype_data_application_json_model_json2 = toolchain_event_prototype_data_application_json_model.to_dict()
        assert toolchain_event_prototype_data_application_json_model_json2 == toolchain_event_prototype_data_application_json_model_json
