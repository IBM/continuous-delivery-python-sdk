...
class ToolchainEventPrototypeData:
    ...
    def from_dict(cls, _dict: Dict) -> 'ToolchainEventPrototypeData':
        ...
        if 'application_json' in _dict:
            args['application_json'] = ToolchainEventPrototypeDataApplicationJson.from_dict(_dict.get('application_json'))
...
class ToolchainEventPrototypeDataApplicationJson:
    ...
    def from_dict(cls, _dict: Dict) -> 'ToolchainEventPrototypeDataApplicationJson':
        ...
        if 'content' in _dict:
            ...
            raise ValueError('Required property \'content\' not present in ToolchainEventPrototypeDataApplicationJson JSON')
        return cls(**args)
